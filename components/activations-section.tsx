...
const processSteps = [
  {
    icon: Search,
    title: "Discovery",
    description: "We dive deep into your business goals, target audience, and current market position.",
    cta: "Step 1",
  },
  {
    icon: Target,
    title: "Strategy",
    description: "Our experts craft a custom, data-driven marketing plan tailored to your objectives.",
    cta: "Step 2",
  },
  {
    icon: Rocket,
    title: "Execution",
    description: "We deploy campaigns across chosen channels with precision and impact.",
    cta: "Step 3",
  },
  {
    icon: LineChart,
    title: "Optimization",
    description: "Continuous monitoring, A/B testing, and scaling to maximize your ROI.",
    cta: "Step 4",
  },
]
    ...
    <section id="process" className="relative py-16 bg-white overflow-hidden">
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          ...
          >
            Our proven 4-step methodology to deliver measurable growth and ROI.
          </motion.p>
        </motion.div>
        ...
        >
          {processSteps.map((step, index) => (
            ...
            >
              <motion.div
                className="absolute inset-0 bg-[#BA0807]/0 group-hover:bg-[#BA0807]"
                transition={{ duration: 0.4 }}
              />

              <div className="relative z-10">
                <motion.div
                  className="w-11 h-11 rounded-xl bg-[#BA0807] flex items-center justify-center mb-4 group-hover:bg-[#121212] transition-colors duration-300"
                  whileHover={{ rotate: 10, scale: 1.1 }}
                  transition={{ type: "spring", stiffness: 400, damping: 17 }}
                >
                  <step.icon className="w-5 h-5 text-[#121212] group-hover:text-[#BA0807] transition-colors duration-300" />
                </motion.div>
                ...
                <motion.button
                  className="flex items-center gap-2 text-[#BA0807] group-hover:text-[#121212] font-bold text-xs tracking-wide transition-colors duration-300"
                  whileHover={{ x: 4 }}
                  transition={{ type: "spring", stiffness: 400, damping: 17 }}
                >
                  {step.cta}
