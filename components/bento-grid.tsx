...
import { Search, Share2, MousePointerClick, Code, PenTool, Target } from "lucide-react"
...
const services = [
  ...
  },
  {
    ...
    description: "Targeted campaigns for instant ROI.",
    accent: "#00D4FF",
  },
  {
    icon: Code,
    ...
    description: "High-performance, converting websites.",
    accent: "#BA0807",
  },
  {
    icon: PenTool,
  ...
  },
  {
    ...
    title: "Brand",
    subtitle: "Strategy",
    description: "Define and position your market identity.",
    accent: "#00D4FF",
  },
]

function FeatureCard({ feature, index }: { feature: (typeof services)[0]; index: number }) {
...
export function BentoGrid() {
  ...
  return (
    <section id="services" className="relative py-16 bg-[#121212] overflow-hidden">
      ...
      <div ref={ref} className="max-w-5xl mx-auto px-6 relative z-10">
        ...
        >
          ...
          {/* Animated underline */}
          <motion.div
            className="h-[2px] w-12 bg-[#BA0807] mx-auto mt-3 rounded-full"
            initial={{ scaleX: 0 }}
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
          {services.map((service, index) => (
            <FeatureCard key={service.title} feature={service} index={index} />
          ))}
        </div>
      </div>
    </section>
