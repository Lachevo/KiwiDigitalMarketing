...
const caseStudies = [
  {
    ...
    tagline: "+180% Revenue",
    description: "Scaled online sales through targeted PPC campaigns and conversion rate optimization.",
    image: "/placeholder.svg?height=400&width=300&query=ecommerce+dashboard+growth",
  ...
  },
  {
    id: 2,
    name: "SaaS Lead Gen",
    tagline: "+250% Qualified Leads",
    description: "Built a predictable B2B pipeline using SEO-driven content and LinkedIn outreach.",
    image: "/placeholder.svg?height=400&width=300&query=saas+analytics+leads",
  ...
  },
  {
    ...
    tagline: "+300% Organic Traffic",
    description: "Dominated local search results with aggressive local SEO and review management.",
    image: "/placeholder.svg?height=400&width=300&query=local+business+map+growth",
...
export function FlavorCarousel() {
  ...
  return (
    <section id="our-work" className="relative py-16 bg-white overflow-hidden">
      <motion.div
        className={`absolute inset-0 bg-gradient-to-br ${currentStudy.bgColor}`}
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
                  ...
                  <div className="grid md:grid-cols-2 gap-6 items-center">
                    ...
                    <div className="space-y-4">
                      ...
                      >
                        ...
                        >
                          {["Strategy", "Execution", "Analytics", "Growth"].map((badge) => (
                            <span
                              key={badge}
                        ...
                        <motion.button
                          ...
                          whileTap={{ scale: 0.98 }}
                          transition={{ type: "spring", stiffness: 400, damping: 17 }}
                          style={{ backgroundColor: currentStudy.accentColor, color: "#121212" }}
                          initial={{ opacity: 0, y: 20 }}
                          animate={{ opacity: 1, y: 0 }}
                        >
                          <motion.span
          ...
          <div className="flex justify-center gap-2 mt-6">
            {caseStudies.map((study, index) => (
              <motion.button
                ...
                style={{
                  backgroundColor: index === currentIndex ? study.accentColor : "#12121220",
                }}
                animate={{
