...
export function Footer() {
  ...
  const footerLinks = [
    {
      title: "Services",
      links: ["SEO Optimization", "PPC Advertising", "Social Media", "Web Development"],
    },
    {
      title: "Company",
      links: ["About Us", "Careers", "Case Studies", "Contact"],
    },
    {
      title: "Resources",
      links: ["Blog", "Marketing Guides", "Webinars", "Newsletter"],
    },
    {
      title: "Legal",
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          <div className="flex flex-col sm:flex-row gap-3">
            ...
            <motion.button
              className="bg-[#BA0807] text-[#121212] px-6 py-3 rounded-xl font-bold text-sm tracking-wide whitespace-nowrap relative overflow-hidden"
            ...
            >
              ...
              >
                {isSubmitting ? "Booking..." : "Book Your Free Strategy Call"}
              </motion.span>
            </motion.button>
          </div>
          <motion.p
          ...
          >
            Join 500+ growing companies. No spam, just results.
          </motion.p>
        </motion.div>
        ...
        >
          <p className="text-white/60 font-mono text-xs max-w-xl mx-auto leading-relaxed">
            Let's create a digital marketing strategy that delivers measurable results. We focus on ROI, transparent reporting, and scaling your revenue.
          </p>
        </motion.div>
                ...
                {section.links.map((item) => (
                  <li key={item}>
                    <motion.div whileHover={{ x: 4 }} transition={{ type: "spring", stiffness: 400, damping: 17 }}>
                      <Link
                        href="#"
                        className="text-white/60 hover:text-[#BA0807] font-mono text-xs transition-colors inline-block"
                      >
                        {item}
                      </Link>
                    </motion.div>
        ...
        >
          ...
          >
            <span className="text-xl font-black">
              ...
              <span className="text-[#BA0807]">vate</span>
            </span>
          </motion.div>

          <p className="text-white/40 font-mono text-xs">© 2026 Elevate Digital. All rights reserved.</p>
