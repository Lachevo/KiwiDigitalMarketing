...
export function HeroSection() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-white via-[#BA0807]/5 to-white" />

      <motion.div
        className="absolute top-20 left-10 w-24 h-24 rounded-full bg-[#BA0807]/20 blur-3xl"
        animate={{
          x: [0, 30, 0],
          y: [0, -20, 0],
          scale: [1, 1.1, 1],
      ...
      />
      <motion.div
        className="absolute bottom-40 right-20 w-32 h-32 rounded-full bg-[#BA0807]/10 blur-3xl"
        animate={{
          x: [0, -40, 0],
          y: [0, 30, 0],
          scale: [1, 1.2, 1],
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 pt-24 pb-12">
        <div className="grid lg:grid-cols-2 gap-8 items-center">
          ...
          <motion.div style={{ opacity }} className="space-y-5">
            ...
            >
              <motion.span
                className="w-2 h-2 bg-[#BA0807] rounded-full"
            ...
            >
              <motion.button
                className="bg-[#BA0807] text-[#121212] px-6 py-3 rounded-full font-bold text-sm tracking-wide flex items-center gap-2 group relative overflow-hidden"
            ...
            >
              {["Full-Service Agency", "In-House Production", "Proven Results", "Based in Addis"].map((benefit, i) => (
                ...
                >
                  <div className="w-1.5 h-1.5 bg-[#BA0807] rounded-full" />
                  {benefit}
                </motion.div>
              ))}
            </motion.div>
          ...
          <motion.div style={{ y, scale }} className="relative flex justify-center">
            <motion.div variants={scaleInVariants} initial="hidden" animate="visible" className="relative">
              <motion.div
                className="absolute inset-0 bg-[#BA0807]/30 blur-[80px] rounded-full scale-75"
                animate={{
              ...
              >
                <Image
                  src="/placeholder.svg?height=525&width=350&query=digital+marketing+dashboard+growth+analytics"
